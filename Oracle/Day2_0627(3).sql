...
SELECT * FROM TBL_MEMBER WHERE name LIKE '다현%';		-- 다현으로 시작하는
...
--오라클의 to_date함수는 문자열을 날짜형식으로 변환.
INSERT INTO tbl_member 
VALUES (3,'최다현','dahy@naver.com',to_date('2022-03-04 16:47','YYYY-MM-DD HH24:MI'));
SELECT * FROM TBL_MEMBER tm ;

--to_char 함수 : 날짜형식에서 문자열로 변경한다. 두번째 인자는 패턴 -> 년도 또는 일부 값만 추출

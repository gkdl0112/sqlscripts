-- 제약 조건 설정은 create table, alter table 에서 한다.
...
INSERT INTO tbl#(col1,col2,col3) VALUES ('english',89,'science'); -- 오류 : 무결성 제약 조건(UNIQUE)에 위배됩니다
INSERT INTO tbl#(col1,col2,col3) VALUES ('english',89,'math');

-- 체크 사항 : unique 컬럼에는 null 허용? O

-- 제약 조건 3) 기본키 (primary key)는 not null + unique 제약조건.
...
--	성별 gender 컬럼의 제약조건 변경은 삭제(drop) 후 추가(add) 해해야 한다.
